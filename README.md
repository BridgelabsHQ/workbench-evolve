...
The desktop app ships a universal macOS binary that runs on Apple Silicon
(arm64) and Intel (x64) Macs. The Linux x64 AppImage
is alpha: expect problems, and please report them. On Windows, run bb inside
